...
exports.scheduledKeepersExpirationsDev = functions.https.onRequest(async (request, response) => {
...
exports.scheduledKeepersExpirationsDemo = functions.https.onRequest(async (request, response) => {
