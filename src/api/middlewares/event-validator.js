...
class EventValidator {
    ...
    static async ValidateUserVoucherMetadata(req, res, next) {
        ...
        if (!req.body.hasOwnProperty('_tokenIdVoucher') || !req.body._tokenIdVoucher) {
    ...
    static async ValidateVoucherMetadataOnTransfer(req, res, next) {
        ...
        if (!metadata.hasOwnProperty('voucherSupplies') || !metadata.voucherSupplies.length) {
    ...
    static async ValidateVoucherMetadata(req, res, next) {
        ...
        if (!req.body.hasOwnProperty('_tokenIdSupply') || !req.body._tokenIdSupply) {
