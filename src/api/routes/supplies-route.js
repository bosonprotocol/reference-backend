...
class VoucherSuppliesRouter {
    ...
    static route(expressApp) {
        ...
        router.patch('/set-supply-meta',
            ...
            ErrorHandlers.globalErrorHandler(voucherSuppliesController.setSupplyMetaOnOrderCreated));
        ...
        router.delete('/:id',
            ...
            ErrorHandlers.globalErrorHandler(voucherSuppliesController.deleteVoucherSupply));
